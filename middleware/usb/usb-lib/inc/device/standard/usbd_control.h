...
/*!******************************************************************
 * \fn USBD_CONTROL_status_t USBD_CONTROL_init(USBD_CONTROL_data_callbacks_t* data_callbacks)
 * \brief Init USB device control pipe driver.
 * \param[in]   data_callbacks: Pointer to the standard requests callbacks.
 * \param[out]  none
