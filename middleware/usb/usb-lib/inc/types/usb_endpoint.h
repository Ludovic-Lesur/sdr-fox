...
/*!******************************************************************
 * \enum USB_endpoint_number_t
 * \brief USB endpoint numbers list.
 *******************************************************************/
typedef enum {
    USB_ENDPOINT_NUMBER_EP0 = 0,
    USB_ENDPOINT_NUMBER_EP1,
    USB_ENDPOINT_NUMBER_EP2,
    USB_ENDPOINT_NUMBER_EP3,
    USB_ENDPOINT_NUMBER_EP4,
    USB_ENDPOINT_NUMBER_EP5,
    USB_ENDPOINT_NUMBER_EP6,
    USB_ENDPOINT_NUMBER_EP7,
    USB_ENDPOINT_NUMBER_EP8,
    USB_ENDPOINT_NUMBER_EP9,
    USB_ENDPOINT_NUMBER_EP10,
    USB_ENDPOINT_NUMBER_EP11,
    USB_ENDPOINT_NUMBER_EP12,
    USB_ENDPOINT_NUMBER_EP13,
    USB_ENDPOINT_NUMBER_EP14,
    USB_ENDPOINT_NUMBER_EP15,
    USB_ENDPOINT_NUMBER_LAST
} USB_endpoint_number_t;
